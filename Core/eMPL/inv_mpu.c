...
extern int  sw_i2c_write(uint8_t slave_addr, uint8_t reg_addr, uint8_t len, uint8_t *data);
extern int  sw_i2c_read(uint8_t slave_addr, uint8_t reg_addr, uint8_t len, uint8_t *data);

#define i2c_write(slave_addr, reg_addr, length, data) \
        sw_i2c_write(slave_addr, reg_addr, length, data)
#define i2c_read(slave_addr, reg_addr, length, data) \
        sw_i2c_read(slave_addr, reg_addr, length, data)
